...
Tras la incompatibilidad del proyecto de Jruby en GAE busco la opción más parecida posible que me ofrezca soporte, en este caso Google Cloud Platform. Tras investigar encuentro multitud de \href{https://cloud.google.com/launcher/explore}{lenguajes compatibles}, entre ellos Ruby, sin embargo, los servicios de esta nube son de pago, aunque existe una versión demo durante 60 días. Debido al tiempo que emplearía en el estudio, desarrollo y pruebas, este período puede resultar corto. Me pongo en contacto con el servicio de clientes y soporte de Google para bajar otras opciones, pero no ofrecen nada que me sea viable para desarrollar mi proyecto.\\
...
\todo{los enlaces de lenguajes en la tabla, mejor específica que lenguajes son. Si te sale una tabla muy grande, resumelos}
...
\todo{puedes comentar aquí las dos entrevistas que tuvistes y ponerlos con el rol cliente}
...
\todo{Es la primera vez que leo el nombre de la aplicación en el texto de la intruducción. Deberías nombrarlo antes, en el primer parrafo de la intro por ejemplo}
